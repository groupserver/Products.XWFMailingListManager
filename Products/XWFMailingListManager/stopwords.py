#TODO: Check if anyone uses this still.
en = ['am', 'ii', 'iii', 'per', 'po', 're', 'a', 'about', 'above',
    ...
    'both', 'bottom', 'but', 'by', 'can', 'cannot', 'cant', 'come', 'con',
    'could', 'couldnt', 'cry', 'describe', 'detail', 'do', 'does', 'done',
    ...
    'over', 'own', 'per', 'perhaps', 'please', 'pre', 'put', 'quite',
    'rather', 're', 'said', 'says', 'same', 'see', 'seem', 'seemed',
    ...
    'think', 'third', 'this', 'thing', 'things', 'those', 'though',
    'three', 'through', 'throughout', 'thru', 'thus', 'to', 'together',
    'too', 'toward', 'towards', 'twelve', 'twenty', 'two', 'un', 'under',
