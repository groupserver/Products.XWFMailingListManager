en = ['am', 'ii', 'iii', 'per', 'po', 're', 'a', 'about', 'above', 'across',
    ...
    'couldnt', 'cry', 'describe', 'detail', 'do', 'does', 'done', 'down', 'due',
    ...
    'less', 'like', 'lot', 'made', 'many', 'may', 'me', 'meanwhile', 'might', 'mill',
    ...
    'until', 'up', 'upon', 'us', 'very', 'via', 'want', 'was', 'we', 'well',
